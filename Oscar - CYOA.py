...
class Room(object):
    def __init__(self, name, north, south, west, east, attack, desc):
        self.name = name
        self.north = north
        self.south = south
        self.west = west
...
NorthGreenLight = Room("NorthGreenLight", "NORTHSHACK", "SouthBeach", None, None, None,
...
CAVERNHALLWAY = Room("Cavern Hallway", None, None, None, "CAVERNINTERSECTIONEAST", None,
                     ...
                     "island")
CAVERNEXIT = Room("Cavern Exit", "ABANDONEDTOWN", None, None, None, None,
